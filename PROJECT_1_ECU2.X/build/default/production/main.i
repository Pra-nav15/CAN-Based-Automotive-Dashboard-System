...
void main(void)
{
    ...
    while (1)
    {
        ecu2_key = read_digital_keypad(0);
        if (ecu2_key != 0x0F)
        {
            if (ecu2_key == 0x0E)
            {
            ...
            else if (ecu2_key == 0x0D)
            {
                mode = 2;
            }
            else if (ecu2_key == 0x0B)
            {
                mode = 3;
            }
            else if (ecu2_key == 0x07)
            {
                mode = 4;
            }
        }
        adc_reg_value = read_adc(0x04);
        rpm = (adc_reg_value)/10.23;
        can_transmit(0x30, &rpm, sizeof (char));
        _delay((unsigned long)((80)*(20000000/4000.0)));
        can_transmit(0x40, &mode, sizeof (char));
        _delay((unsigned long)((80)*(20000000/4000.0)));
    }
}
