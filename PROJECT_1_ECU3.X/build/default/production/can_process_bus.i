...
# 10 "can_process_bus.c" 2
# 1 "./message_id.h" 1
# 11 "can_process_bus.c" 2
# 1 "./clcd_display.h" 1
# 42 "./clcd_display.h"
void init_clcd(void);
...
void can_process_bus(void)
{
    ...
    clcd_print("SPD",(0x80 + (0)));
    clcd_print("GR",(0x80 + (4)));
    clcd_print("RPM",(0x80 + (8)));
    clcd_print("IND",(0x80 + (12)));
